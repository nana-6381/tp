...
public class JsonAdaptedSession {
    ...
    private final List<JsonAdaptedService> services;
    ...
    public JsonAdaptedSession(Session source) {
        ...
        this.services = source.getServices().stream()
    ...
    public Session toModelType() throws IllegalValueException {
        ...
        for (JsonAdaptedService js : services) {
            modelServices.add(js.toModelType());
        }
